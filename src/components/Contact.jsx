        ...
        <div style={{
          ...
          >
            ...
            <p className="body-text" style={{ marginBottom: 'var(--sp-8)', fontSize: 'var(--text-lg)' }}>
              I'm open to discussing engineering roles, consulting, or freelance client projects.
              Whether you have an upcoming product launch or want to discuss technical architecture,
              I'd love to chat.
            </p>
