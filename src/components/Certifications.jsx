...
import { certifications, softSkills, personalInfo } from '../data/portfolio';
          ...
          <div>
            ...
            >
              ...
              <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)', lineHeight: '1.65' }}>
                {personalInfo.activeStatus || "AWS Certified Solutions Architect & Cloud Engineering Practice (Ongoing)"}
              </p>
            </motion.div>
          </div>
