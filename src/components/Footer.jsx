        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              {personalInfo.firstName || personalInfo.name.split(' ')[0]}<span style={{ color: 'var(--accent)' }}>.</span>
            </div>
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-muted)', maxWidth: '300px', lineHeight: '1.6' }}>
              {personalInfo.title} &amp; {personalInfo.subtitle} based in {personalInfo.location}.
            </p>
          </div>
